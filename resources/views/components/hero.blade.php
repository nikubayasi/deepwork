    ...
    <div class="container mx-auto text-center z-10">
        ...
        <form class="block mx-5 space-y-2 md:mx-auto md:space-x-2">
            <input type="text" name="keywords" placeholder="Keywords"
                class="w-full md:w-72 px-4 py-3 focus:outline-none rounded-lg" />
            <input type="text" name="location" placeholder="Location"
                class="w-full md:w-72 px-4 py-3 focus:outline-none rounded-lg" />
            <button
                class="w-full md:w-auto rounded-xl bg-orange-500 hover:bg-blue-600 text-white px-4 py-3 focus:outline-none">
